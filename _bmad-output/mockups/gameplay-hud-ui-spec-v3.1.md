# Gameplay HUD — UI Specification v3.1
...
│   └── BottomBar                        RectTransform (stretch-bottom, h=246)
...
BottomBar height = ActionPill(~162px) + bottomPadding(28px CSS × 3 = 84px) = **246px**
...
private const float BottomBarHeight = 246f;        // CSS: ActionPill(~162) + bottomPadding(28px × 3 = 84)
